...
\titleformat{\part}[display]
    ...
    {\Large Part \thepart}
    {1\baselineskip}
    {\huge\addfontfeatures{LetterSpace=25}}
\titlespacing*{\part}
    {0pt}
    {0.35\textheight}
    {0pt}

% Chapter formatting - small caps, centered, dropped 1/3 down page
...
% Recipe title (section) - refined small caps with letterspacing
\titleformat{\section}
...
% Subsection - "Ingredients", "Instructions" - understated small caps
...
{\huge\scshape\addfontfeatures{LetterSpace=30}{{COOKBOOK_TITLE_LOWER}}}
\par}
\end{titlepage}
...
{\centering
\vspace*{0.3\textheight}
{\huge\scshape\addfontfeatures{LetterSpace=30}{{COOKBOOK_TITLE_LOWER}}}\\[2\baselineskip]
...
\epigraph{\itshape``It's a cookbook!''}{---\textsc{The Twilight Zone}, 1962}
