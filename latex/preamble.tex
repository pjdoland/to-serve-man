...
\pagestyle{fancy}
\fancyhf{}
% Running headers: all caps, 8.5pt
\fancyhead[LE]{\fontsize{8.5}{10}\selectfont\MakeUppercase{\leftmark}}
\fancyhead[RO]{\fontsize{8.5}{10}\selectfont\MakeUppercase{\rightmark}}
