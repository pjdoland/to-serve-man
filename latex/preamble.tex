...
% Chapter formatting - centered (category title pages)
...
\titleformat{\section}
    ...
    {0pt}
    {}
    % No extra space after recipe title - metadata comes right after
...
\setlist[enumerate]{
    label={\fontsize{12}{14}\fontseries{sb}\selectfont\arabic*.},
    leftmargin=3em,
    itemsep=0pt,
    parsep=0pt,
    topsep=0.5em
